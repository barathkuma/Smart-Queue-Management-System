"""
Django settings for Smart Queue Management System.
"""
import os
...
if DB_ENGINE in ('postgres', 'postgresql'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'smartqueue_db'),
...
# CORS Configuration
cors_origins_raw = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000')
CORS_ALLOWED_ORIGINS = [origin.strip() for origin in cors_origins_raw.split(',') if origin.strip()]
CORS_ALLOW_CREDENTIALS = True
CORS_ALLOW_ALL_ORIGINS = DEBUG  # Allow all in debug mode for seamless development
